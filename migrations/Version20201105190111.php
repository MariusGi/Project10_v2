...
final class Version20201105190111 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE public_holiday (id INT AUTO_INCREMENT NOT NULL, country_id INT DEFAULT NULL, year SMALLINT NOT NULL, month_day TEXT NOT NULL, total_amount SMALLINT NOT NULL, INDEX IDX_8744ED86F92F3E70 (country_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
